...
Invoke-KriticalLensSweep -Root 'C:\NoOneDrive\Github\Kritical.PS.Pax8Mcp'
...
Invoke-KriticalLensLanguageSweep -Root 'C:\NoOneDrive\Github\Kritical.PS.Pax8Mcp'

# both families, plus a combined receipt
Invoke-KriticalLensEstateSweep -Roots 'C:\NoOneDrive\Github\Kritical.PS.Pax8Mcp'

# end-of-turn gate (parser + PsLint auto-fix + PSScriptAnalyzer + Lens + corpus top-up)
& "$lens\scripts\Invoke-KritEndOfTurnGate.ps1" -Repo 'C:\NoOneDrive\Github\Kritical.PS.Pax8Mcp'
```
